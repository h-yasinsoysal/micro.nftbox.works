...
<form method="get" class="js-form-order-filtering">
    ...
    <div class="manage-toobar d-flex justify-content-between align-items-center">
        ...
        <div id="cartsnav">
            ...
            <a href="<?php echo e(route('admin.order.index')); ?>" class="btn btn-link btn-sm px-0 <?php if (!isset($abandoned)): ?>font-weight-bold text-dark active<?php else: ?>text-muted<?php endif; ?>"><?php _e("Completed orders"); ?></a>
            <a href="<?php echo e(route('admin.order.abandoned')); ?>" class="btn btn-link btn-sm <?php if (isset($abandoned)): ?>font-weight-bold text-dark active<?php else: ?>text-muted<?php endif; ?>"><?php _e("Abandoned carts"); ?></a>
        </div>
...
</form><?php /**PATH /home/nftboxworks/micro.nftbox.works/src/MicroweberPackages/Order/resources/views/admin/orders/partials/order_filtering.blade.php ENDPATH**/ ?>