        ...
        <div class="card-header d-flex align-items-center col-12">
            <div class="col-md-7 d-flex justify-content-md-start justify-content-center align-items-center px-0">
               ...
               <div class="col-5 d-flex justify-content-md-end justify-content-center my-md-0 mt-2 pr-0">
                   <?php echo $__env->make('order::admin.orders.partials.order_search', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
               </div>
        </div>
...
<?php /**PATH /home/nftboxworks/micro.nftbox.works/src/MicroweberPackages/Order/resources/views/admin/orders/index.blade.php ENDPATH**/ ?>