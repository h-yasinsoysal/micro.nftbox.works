...
use MicroweberPackages\Multilanguage\Repositories\MultilanguageTranslateRepository;
...
class MultilanguageObserver
{
    ...
    public function retrieved(Model $model)
    {
        ...
        if (!empty($model->translatable)) {
            ...
            $findTranslations = MultilanguageTranslateRepository::getTranslationsByRelTypeAndRelId($model->getTable(), $model->id);
