...
<div class="mw-flex-row slider-options">
    <div class="mw-flex-col-xs-4 ">
        <div class="form-group">
            <label class="control-label d-block"><?php _lang("Pager", "templates/tema"); ?></label>
            <select name="pager" class="mw_option_field selectpicker" data-width="100%" option_group="<?php print $params['id'] ?>">
                <option value="false" <?php if ($pager == 'false'): ?> selected="selected" <?php endif ?>><?php _lang("False", "templates/tema"); ?></option>
                <option value="true" <?php if ($pager == 'true'): ?> selected="selected" <?php endif ?>><?php _lang("True", "templates/tema"); ?></option>
            </select>
        </div>
    </div>
    ...
    <div class="mw-flex-col-xs-4 ">
        <div class="form-group">
            <label class="control-label d-block"><?php _lang("Controls", "templates/tema"); ?></label>
            <select name="controls" class="mw_option_field selectpicker" data-width="100%" option_group="<?php print $params['id'] ?>">
                <option value="false" <?php if ($controls == 'false'): ?> selected="selected" <?php endif ?>><?php _lang("False", "templates/tema"); ?></option>
                <option value="true" <?php if ($controls == 'true'): ?> selected="selected" <?php endif ?>><?php _lang("True", "templates/tema"); ?></option>
            </select>
        </div>
    </div>
    ...
    <div class="mw-flex-col-xs-4 ">
        <div class="form-group">
            <label class="control-label d-block"><?php _lang("Loop", "templates/tema"); ?></label>
            <select name="loop" class="mw_option_field selectpicker" data-width="100%" option_group="<?php print $params['id'] ?>">
                <option value="false" <?php if ($loop == 'false'): ?> selected="selected" <?php endif ?>><?php _lang("False", "templates/tema"); ?></option>
                <option value="true" <?php if ($loop == 'true'): ?> selected="selected" <?php endif ?>><?php _lang("True", "templates/tema"); ?></option>
            </select>
        </div>
    </div>
    ...
    <div class="mw-flex-col-xs-4 ">
        <div class="form-group">
            <label class="control-label d-block"><?php _lang("Adaptive Height", "templates/tema"); ?></label>
            <select name="adaptive_height" class="mw_option_field selectpicker" data-width="100%" option_group="<?php print $params['id'] ?>">
                <option value="false" <?php if ($adaptiveHeight == 'false'): ?> selected="selected" <?php endif ?>><?php _lang("False", "templates/tema"); ?></option>
                <option value="true" <?php if ($adaptiveHeight == 'true'): ?> selected="selected" <?php endif ?>><?php _lang("True", "templates/tema"); ?></option>
            </select>
        </div>
    </div>
    ...
    <div class="mw-flex-col-xs-4 ">
        <div class="form-group">
            <label class="control-label d-block"><?php _lang("Autoplay Speed" , "templates/tema"); ?></label>
    ...
    <div class="mw-flex-col-xs-4 ">
        <div class="form-group">
            <label class="control-label d-block"><?php _lang("Pause on hover", "templates/tema"); ?></label>
            <select name="pause_on_hover" class="mw_option_field selectpicker" data-width="100%" option_group="<?php print $params['id'] ?>">
                <option value="false" <?php if ($pauseOnHover == 'false'): ?> selected="selected" <?php endif ?>><?php _lang("False", "templates/tema"); ?></option>
                <option value="true" <?php if ($pauseOnHover == 'true'): ?> selected="selected" <?php endif ?>><?php _lang("True", "templates/tema"); ?></option>
            </select>
        </div>
    </div>
    ...
    <div class="mw-flex-col-xs-4 ">
        <div class="form-group">
            <label class="control-label d-block"><?php _lang("Autoplay", "templates/tema"); ?></label>
            <select name="autoplay" class="mw_option_field selectpicker" data-width="100%" option_group="<?php print $params['id'] ?>">
                <option value="false" <?php if ($autoplay == 'false'): ?> selected="selected" <?php endif ?>><?php _lang("False", "templates/tema"); ?></option>
                <option value="true" <?php if ($autoplay == 'true'): ?> selected="selected" <?php endif ?>><?php _lang("True", "templates/tema"); ?></option>
            </select>
        </div>
    </div>
    ...
    <div class="mw-flex-col-xs-4 ">
        <div class="form-group">
            <label class="control-label d-block"><?php _lang("Draggable", "templates/tema"); ?></label>
            <select name="draggable" class="mw_option_field selectpicker" data-width="100%" option_group="<?php print $params['id'] ?>">
                <option value="false" <?php if ($draggable == 'false'): ?> selected="selected" <?php endif ?>><?php _lang("False", "templates/tema"); ?></option>
                <option value="true" <?php if ($draggable == 'true'): ?> selected="selected" <?php endif ?>><?php _lang("True", "templates/tema"); ?></option>
            </select>
        </div>
    </div>
    ...
    <div class="mw-flex-col-xs-4 ">
        <div class="form-group">
            <label class="control-label d-block"><?php _lang("Fade", "templates/tema"); ?>
            ...
            <select name="fade" class="mw_option_field selectpicker" data-width="100%" option_group="<?php print $params['id'] ?>">
                <option value="false" <?php if ($fade == 'false'): ?> selected="selected" <?php endif ?>><?php _lang("False", "templates/tema"); ?></option>
                <option value="true" <?php if ($fade == 'true'): ?> selected="selected" <?php endif ?>><?php _lang("True", "templates/tema"); ?></option>
            </select>
        </div>
    </div>
    ...
    <div class="mw-flex-col-xs-4 ">
        <div class="form-group">
            <label class="control-label d-block"><?php _lang("Focus On Select", "templates/tema"); ?></label>
            <select name="focus_on_select" class="mw_option_field selectpicker" data-width="100%" option_group="<?php print $params['id'] ?>">
                <option value="false" <?php if ($focusOnSelect == 'false'): ?> selected="selected" <?php endif ?>><?php _lang("False", "templates/tema"); ?></option>
                <option value="true" <?php if ($focusOnSelect == 'true'): ?> selected="selected" <?php endif ?>><?php _lang("True", "templates/tema"); ?></option>
            </select>
        </div>
    </div>
    ...
    <div class="mw-flex-col-xs-4 ">
        <div class="form-group">
            <label class="control-label d-block"><?php _lang("Center Padding", "templates/tema"); ?></label>
