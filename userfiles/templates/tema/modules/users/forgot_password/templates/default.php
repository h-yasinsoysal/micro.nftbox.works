            ...
            <div class="box-title margin-bottom-20">
                <h5 class="size-20">
                    <?php if (!isset($form_title) or $form_title == false): ?>
                        <?php _lang("Enter your username or email", "templates/tema"); ?>
                    <?php else: ?>
                ...
                <div class="clearfix">
                    ...
                    <div class="form-group">
                        <div class="input-group mb-0">
                            ...
                            <input required="" type="text" class="form-control" placeholder="<?php _lang("Email or username", "templates/tema"); ?>" name="username">
                        </div>
                        <b class="tooltip tooltip-bottom-right">"<?php _lang("Needed to verify your account", "templates/tema"); ?></b>
                    </div>
