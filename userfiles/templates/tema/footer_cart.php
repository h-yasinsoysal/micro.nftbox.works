    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="btn-close text-end" data-bs-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
            </div>
            ...
            <div class="modal-body">
                ...
                <div class="js-register-window" style="display:none;">
                    ...
                    <div class="act login">
                        <a href="#" class="js-show-login-window"><span><?php _lang("Back to Login", "templates/tema") ?></span></a>
                    </div>
                </div>
            </div>
        </div>
