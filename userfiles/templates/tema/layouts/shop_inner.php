                ...
                <div class="col-xl-10">
                                        ...
                                        <div class="col-12 d-flex">
                                            ...
                                            <div class="availability col-6 text-end align-self-center">
                                                <?php if ($in_stock == true): ?>
                                                    <span class="text-success"><i class="fas fa-circle" style="font-size: 8px;"></i> <?php _lang("In Stock", 'templates/tema') ?></span> <span class="text-muted"><?php if ($available_qty != ''): ?>(<?php echo $available_qty; ?>)<?php endif; ?></span>
                                                <?php else: ?>
                                                    <span class="text-danger"><i class="fas fa-circle" style="font-size: 8px;"></i> <?php _lang("Out of Stock", 'templates/tema') ?></span>
                                                <?php endif; ?>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-5">
                                        <div class="col-12">
                                            <div class="description">
                                                <div class="edit mw-tpl-tema-product-description" field="content_body" rel="content">
                                                   ...
                                                   features — try to
                                                            limit each one to 5-8 words.", 'templates/tema') ?></p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="edit safe-mode nodrop mt-5" field="related_products" rel="module">
                        <div class="col-12 text-start">
                            <h5><?php _lang('Related products', 'templates/tema'); ?></h5>
